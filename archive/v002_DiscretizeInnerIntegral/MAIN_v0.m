...
%%%% NOTES:
%
% This method seems to work reasonably well,but runs very slow due to poor
% vectorization of the code. I think that it is finding solutions that are 
% feasible but sub optimal.
%
...
rMax = 10;
vMax = 5;
alpha = 0.0;  %smoothing for objective function
