\begin{abstract}
  We consider the problem of matching a given fluence map $f$ as well as possible in
  ...
  an inner optimization computes the optimal leaf trajectories,
  given a dose rate trajectory,
  and an outer optimization computes the dose rate trajectory that
