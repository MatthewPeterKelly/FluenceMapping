...
plot(tGrid,xLow,'r-o','LineWidth',2,'MarkerSize',8);
plot(tGrid,xUpp,'b-o','LineWidth',2,'MarkerSize',8);
xlabel('time (s)');
ylabel('leaf position (cm)');
legend('Leaf One','Leaf Two','Location','SouthEast');

subplot(1, 2, 1); hold on;
plot(fTarget,xGrid,'k-o','LineWidth',2,'MarkerSize',8)
plot(fDelivered,xGrid,'r-x','LineWidth',2,'MarkerSize',8)
